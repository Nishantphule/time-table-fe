    ...
    return (
        <div className='col-12 col-md-6 col-lg-4'>
            <div className="form_box" style={{ border: "5px solid #9ddde3" }}>
                <div className="form_title" style={{ background: "#c7eaed", color: "#105c62" }}>
                            ...
                            <tbody>
                                <tr>
                                    <td className="label-cell">
                                        <label htmlFor="day-select" className="label">Day:</label>
                                    </td>
                                    <td>
                                        <select
                                            id="day-select"
                                ...
                                <tr>
                                    <td className="label-cell">
                                        <label htmlFor="slot-select" className="label">Slot:</label>
                                    </td>
                                    <td>
                                        <select
                                            id="slot-select"

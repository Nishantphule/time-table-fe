...
const CenterWise = () => {
    ...
    const [examCenters, setExamCenters] = useState([1, 2, 3, 46]);
    ...
    return (
        <div className='col-12 col-md-6 col-lg-4'>
            <div className="form_box" style={{ border: "5px solid #95d37c" }}>
                <div className="form_title" style={{ background: "#d7edc7", color: "#2a5e03" }}>
                            ...
                            <tbody>
                                <tr>
                                    <td className="label-cell">
                                        <label htmlFor="exam-center-select" className='label'>Exam Center:</label>
                                    </td>
                                    <td>
                                        <select
